...
// Calculate item width to fill the width of the container while maintaining minimum item width
function calcTabWidth() {
    ...
    // If content of a tab is wider than the global tab width, the tab will use more space
    for (var i = 0; i < views.length; ++i) {
